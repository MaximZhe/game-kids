...
$contents = file_get_contents('https://star-boxs.ru/game/users.json'); // Мы загрузили содержимое нашего файла.
...
file_put_contents('https://star-boxs.ru/game/users.json', $json);
